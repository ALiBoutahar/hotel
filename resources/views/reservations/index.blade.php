                ...
                <tr >
                    ...
                    <td style="height: 20px">
                        <form action="{{ url('reservations/'. $a->id) }}" method="POST">
                            ...
                            <a href="{{url('reservations/'. $a->id .'/edit') }}" style="margin-left:10px"><i class="fa fa-edit" style="color:rgb(4, 12, 249)" ></i></a>
                            <button class="border-0 bg-transparent text-danger" type="submit" style="margin-left:10px"><i class="fas fa-trash-alt"></i></button>
                            <a href="{{url('clients/'. $a->Client_id .'/edit') }}" style="margin-left:10px"><i class="fas fa-sync-alt" style="color:rgb(37, 237, 23)" ></i></a>
                        </form>
                    </td>
                </tr>
                @endforeach
