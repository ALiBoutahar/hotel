                ...
                <tr class="text-dark">
                    ...
                    <td class="text-center">
                        <form action="{{ url('chambers/'. $a->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <a class="text-info ms-2 border-0 bg-transparent" href="{{url('chambers/'. $a->id) }}">Voir</a>
                            <a class="text-primary ms-2 border-0 bg-transparent" href="{{url('chambers/'. $a->id .'/edit') }}">Modifier</a>
