...
Route::controller(ReservationsController::class)->middleware('auth')->group(function(){
...
Route::controller(ClientsController::class)->middleware('auth')->group(function () {
...
Route::controller(ChambersController::class)->middleware('auth')->group(function () {
